...
@section('content')
    <div class="w3-container w3-section">
        <div class="w3-row-padding" style="margin:0 -16px">
            <div class="w3-third">
                <h5>Regions</h5>
                <img src="http://lorempixel.com/400/400/business/" style="width:100%" alt="Google Regional Map">
            </div>
        ...
        <div class="w3-container">
            ...
            <ul class="w3-ul w3-card-4 w3-white">
                <li class="w3-padding-16">
                    ...
                    <img src="http://lorempixel.com/400/400/business/" class="w3-left w3-circle w3-margin-right" style="width:35px">
        ...
        <div class="w3-container">
            ...
            <div class="w3-row">
                <div class="w3-col m2 text-center">
                    <img class="w3-circle" src="http://lorempixel.com/400/400/business/" style="width:96px;height:96px">
                </div>
